...
import { ArrowRight, CheckCircle2, Globe, Zap, Layers, Bot } from "lucide-react";
...
export function HeroSection() {
  return (
    <section className="relative min-h-[65vh] flex items-center overflow-hidden bg-background">
      ...
      <div className="container relative z-10 mx-auto px-4 pt-20 md:pt-10 pb-16">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            <div className="pt-8 border-t border-border/50">
              ...
              <div className="grid grid-cols-3 gap-y-2 gap-x-4">
                {industries.map((industry) => (
                  <Link key={industry.href} href={industry.href} className="flex items-center gap-2 hover:text-primary transition-colors">
          ...
          <div className="relative hidden lg:block h-full">
            ...
            <div className="relative mx-auto w-full max-w-md xl:max-w-xl 2xl:max-w-160 aspect-square perspective-1000">
              ...
              <div className="absolute inset-0 bg-linear-to-tr from-primary/40 to-primary/60 rounded-full blur-[80px] -z-10" />
